jQuery(document).ready(function ($) {
    ...
    //Shift LR
    { $Duration: 1200, x: 1, $Easing: { $Left: $JssorEasing$.$EaseInOutQuart, $Opacity: $JssorEasing$.$EaseLinear }, $Opacity: 2, $Brother: { $Duration: 1200, x: -1, $Easing: { $Left: $JssorEasing$.$EaseInOutQuart, $Opacity: $JssorEasing$.$EaseLinear }, $Opacity: 1 } },
    //Zoom- in
    ...
    function ScaleSlider() {
        ...
        if (parentWidth)
            jssor_slider1.$ScaleWidth(Math.max(Math.min(parentWidth, 1525), 300));
        else
    ...
    var jssor_slider2 = new $JssorSlider$("slider2_container", options);
            ...
            function ScaleSlider2() {
                ...
                if (bodyWidth)
                    jssor_slider2.$ScaleWidth(Math.min(bodyWidth-30, 1140));
                else

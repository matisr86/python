...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Realisations.title_en'
        db.add_column(u'project_realisations', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Realisations.title_pl'
        db.add_column(u'project_realisations', 'title_pl',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Realisations.title_en'
        db.delete_column(u'project_realisations', 'title_en')

        # Deleting field 'Realisations.title_pl'
        db.delete_column(u'project_realisations', 'title_pl')

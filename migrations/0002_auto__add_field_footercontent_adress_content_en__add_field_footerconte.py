...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FooterContent.adress_content_en'
        db.add_column(u'project_footercontent', 'adress_content_en',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FooterContent.adress_content_pl'
        db.add_column(u'project_footercontent', 'adress_content_pl',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WhatWeDo.title_en'
        db.add_column(u'project_whatwedo', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WhatWeDo.title_pl'
        db.add_column(u'project_whatwedo', 'title_pl',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WhatWeDo.description_en'
        db.add_column(u'project_whatwedo', 'description_en',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WhatWeDo.description_pl'
        db.add_column(u'project_whatwedo', 'description_pl',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'About.main_title_en'
        db.add_column(u'project_about', 'main_title_en',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'About.main_title_pl'
        db.add_column(u'project_about', 'main_title_pl',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'About.title_en'
        db.add_column(u'project_about', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'About.title_pl'
        db.add_column(u'project_about', 'title_pl',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'About.description_en'
        db.add_column(u'project_about', 'description_en',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'About.description_pl'
        db.add_column(u'project_about', 'description_pl',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Banner.about_heading_en'
        db.add_column(u'project_banner', 'about_heading_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Banner.about_heading_pl'
        db.add_column(u'project_banner', 'about_heading_pl',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Banner.about_desc_en'
        db.add_column(u'project_banner', 'about_desc_en',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Banner.about_desc_pl'
        db.add_column(u'project_banner', 'about_desc_pl',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FooterContent.adress_content_en'
        db.delete_column(u'project_footercontent', 'adress_content_en')

        # Deleting field 'FooterContent.adress_content_pl'
        db.delete_column(u'project_footercontent', 'adress_content_pl')

        # Deleting field 'WhatWeDo.title_en'
        db.delete_column(u'project_whatwedo', 'title_en')

        # Deleting field 'WhatWeDo.title_pl'
        db.delete_column(u'project_whatwedo', 'title_pl')

        # Deleting field 'WhatWeDo.description_en'
        db.delete_column(u'project_whatwedo', 'description_en')

        # Deleting field 'WhatWeDo.description_pl'
        db.delete_column(u'project_whatwedo', 'description_pl')

        # Deleting field 'About.main_title_en'
        db.delete_column(u'project_about', 'main_title_en')

        # Deleting field 'About.main_title_pl'
        db.delete_column(u'project_about', 'main_title_pl')

        # Deleting field 'About.title_en'
        db.delete_column(u'project_about', 'title_en')

        # Deleting field 'About.title_pl'
        db.delete_column(u'project_about', 'title_pl')

        # Deleting field 'About.description_en'
        db.delete_column(u'project_about', 'description_en')

        # Deleting field 'About.description_pl'
        db.delete_column(u'project_about', 'description_pl')

        # Deleting field 'Banner.about_heading_en'
        db.delete_column(u'project_banner', 'about_heading_en')

        # Deleting field 'Banner.about_heading_pl'
        db.delete_column(u'project_banner', 'about_heading_pl')

        # Deleting field 'Banner.about_desc_en'
        db.delete_column(u'project_banner', 'about_desc_en')

        # Deleting field 'Banner.about_desc_pl'
        db.delete_column(u'project_banner', 'about_desc_pl')
